...
import CircularCropTool from "@/components/tools/CircularCropTool";

export const metadata: Metadata = {
  title: "Circular Crop",
  description:
    "Crop any image into a perfect circle with radius and position control directly in your browser.",
};
        ...
        <header className="rounded-xl border border-[var(--border)] bg-[color:color-mix(in_oklab,var(--background)_90%,transparent)] px-4 py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">Circular Crop</p>
            </div>
            <Link
              href="/"
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Create a perfect circle crop with adjustable radius and position.
            </p>
          </section>
