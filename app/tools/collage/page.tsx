...
import CollageTool from "@/src/components/tools/phase6/CollageTool";
import ToolPageFrame from "@/src/components/tools/ToolPageFrame";

export const metadata: Metadata = {
  title: "Collage Maker",
  description: "Create image collage layouts with grid columns, spacing, and background controls.",
};
