...
import AsciiArtTool from "@/src/components/tools/phase6/AsciiArtTool";
import ToolPageFrame from "@/src/components/tools/ToolPageFrame";

export const metadata: Metadata = {
  title: "ASCII Art Converter",
  description: "Convert images into text-based ASCII art with adjustable density and styles.",
};
