...
export const metadata: Metadata = {
  ...
  description:
    "Remove image background with AI directly in your browser. No uploads, no signup, fully private.",
};
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              AI-powered background removal in your browser with before/after
              preview and transparent PNG download.
            </p>
          </section>
