...
export const metadata: Metadata = {
  ...
  description:
    "Compress images by adjusting quality and resolution, then export as JPG, WebP, or PNG in your browser.",
};
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Compress image size with quality and resolution controls while
              keeping everything fully in-browser.
            </p>
          </section>
