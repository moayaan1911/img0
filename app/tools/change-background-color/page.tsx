...
import ChangeBackgroundColorTool from "@/components/tools/ChangeBackgroundColorTool";

export const metadata: Metadata = {
  title: "Change Background Color",
  description:
    "Fill transparent regions of images with a solid background color directly in your browser.",
};
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Apply a solid background color to your image without any AI
