...
export const metadata: Metadata = {
  title: "PDF to Image",
  description:
    "Extract PDF pages as PNG, JPG, or WebP in your browser with full privacy.",
};
        ...
        <header className="rounded-xl border border-[var(--border)] bg-[color:color-mix(in_oklab,var(--background)_90%,transparent)] px-4 py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">PDF to Image</p>
            </div>
            <Link
              href="/"
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Extract every PDF page as PNG, JPG, or WebP with adjustable render
