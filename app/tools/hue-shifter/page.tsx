...
export const metadata: Metadata = {
  title: "Hue Shifter",
  description: "Shift the overall color tone of your image using hue rotation.",
};

export default function HueShifterPage() {
  return (
        ...
        <header className="rounded-xl border border-[var(--border)] bg-[color:color-mix(in_oklab,var(--background)_90%,transparent)] px-4 py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">Hue Shifter</p>
            </div>
            <Link
              href="/"
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Rotate hue angle to create alternate color palettes.
            </p>
          </section>

          <ColorFilterTool mode="hue" />
        </main>
