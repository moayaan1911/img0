...
import AddTextOverlayTool from "@/components/tools/AddTextOverlayTool";

export const metadata: Metadata = {
  title: "Add Text Overlay",
  description:
    "Add custom text to images with full control over font, color, shadow, alignment, and position.",
};

export default function AddTextOverlayPage() {
  return (
        ...
        <header className="rounded-xl border border-[var(--border)] bg-[color:color-mix(in_oklab,var(--background)_90%,transparent)] px-4 py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">Add Text Overlay</p>
            </div>
            <Link
              href="/"
        ...
        <main className="space-y-6">
          <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] px-6 py-6 sm:px-10">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)] sm:text-base">
              Add stylish text with custom font, color, shadow, and alignment controls.
            </p>
          </section>
